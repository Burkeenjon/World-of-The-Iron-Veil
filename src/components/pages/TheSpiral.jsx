...
export default function TheSpiral() {
  return (
    <main
    ...
    >
      <div className="max-w-4xl mx-auto bg-black/50 p-6 rounded-xl shadow-xl">
        <h1 className="text-4xl font-bold mb-4 text-center">The Spiral</h1>
        <p className="text-gray-300">
          A model of recursion, memory layering, and metaphysical decay.
        </p>
      </div>
    </main>
  );
